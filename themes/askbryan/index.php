...
<div class="container-fluid">
	<div class="row hero clear">
		<div class="estimate col-md-6 container-fluid">
			<h2>Home Estimate</h2>
			<br/>
...
<!-- Contact Section -->
<div class="contact container-fluid" style="margin-top: 250px;">
	<div class="row">
		<div class="col-md-6">
			...
			<form method="post" action="contact">
				...
				<br />
				<br />
				<input type="text" name="cf_service" placeholder="What Can I Do For You?" style="padding-bottom: 50px;" />
				<br />
				<br />
				<button>Submit</button>
			</form>
				<h2>Click the cards to download my info!</h2>
				<a href="bryan_contact_info"><img src="<?php bloginfo ('template_directory'); ?>/css/images/contact_info.png" alt="contact info" /></a>
		</div>	
	</div>
